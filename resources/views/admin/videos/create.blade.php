...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-700 mb-6">Tambah Video Baru</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.videos.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="url" name="youtube_url" id="youtube_url" value="{{ old('youtube_url') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('youtube_url') border-red-500 @enderror" placeholder="Contoh: [https://www.youtube.com/watch?v=xxxxxxxxx](https://www.youtube.com/watch?v=xxxxxxxxx)">
                @error('youtube_url')
                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                @enderror
            </div>
